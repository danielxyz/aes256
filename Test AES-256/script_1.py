...
# Membuat versi bersih dari kode AES-256 original Anda
# TANPA non-breaking spaces

clean_original_code = """# Aplikasi Enkripsi dan Dekripsi AES-256 dengan GUI Sederhana
# Dibuat menggunakan Python 3
# Diperlukan library: cryptography (instal dengan: pip install cryptography)
# GUI menggunakan Tkinter (sudah built-in di Python)
...
# Save clean version
with open('aes256_app_clean.py', 'w', encoding='utf-8') as f:
    f.write(clean_original_code)

print("✓ File bersih telah dibuat: aes256_app_clean.py")
print("\n=== FILE SUDAH DIBERSIHKAN ===")
print("File baru tanpa non-breaking spaces: aes256_app_clean.py")
print("\nAnda bisa:")
print("1. Download file 'aes256_app_clean.py' ini")
print("2. Copy ke D:\\Test AES-256\\")
print("3. Jalankan: python aes256_app_clean.py")
print("\nATAU rename file lama dan ganti:")
print("   rename aes256_app_decky.py aes256_app_decky_old.py")
print("   rename aes256_app_clean.py aes256_app_decky.py")
