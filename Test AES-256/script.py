...
# Membuat versi GUI yang canggih dengan tampilan blockchain menggunakan CustomTkinter
# Dengan fitur blockchain-style visualization
...
# Save the advanced GUI code
with open('aes256_blockchain_gui.py', 'w', encoding='utf-8') as f:
    f.write(advanced_gui_code)

print("✅ GUI Modern Blockchain-Style telah dibuat!")
print("\n" + "="*60)
print("FILE: aes256_blockchain_gui.py")
print("="*60)
print("\n🎨 FITUR TAMPILAN BLOCKCHAIN:")
print("  ✓ Dark theme modern dengan warna blockchain (cyan, neon)")
print("  ✓ Sidebar dengan kontrol lengkap")
print("  ✓ Panel transaction log seperti blockchain explorer")
print("  ✓ Block numbering dan timestamp")
print("  ✓ Real-time statistics (transactions & blocks mined)")
print("  ✓ Color-coded actions (🔑🔒🔓)")
print("\n🔐 FITUR KEAMANAN:")
print("  ✓ AES-256-CBC encryption")
print("  ✓ HMAC-SHA256 authentication")
print("  ✓ Encrypt-then-MAC pattern")
print("  ✓ Master key (64 bytes) management")
print("\n📦 REQUIREMENTS:")
print("  pip install customtkinter")
print("  pip install cryptography")
print("\n🚀 CARA MENJALANKAN:")
print("  python aes256_blockchain_gui.py")
